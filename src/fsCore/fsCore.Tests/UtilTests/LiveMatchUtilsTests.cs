...
namespace fsCore.Tests.UtilTests
{
    ...
    {
        private class Should_Calculate_LiveMatch_Winner_Correctly_Class_Data
            : TheoryData<LiveMatch, User>
        {
            public Should_Calculate_LiveMatch_Winner_Correctly_Class_Data()
            {
                ...
                var liveMatch = new LiveMatch(
                    ...
                    [],
                    participants,
                    participants.FirstOrDefault()!.Id!,
                    DateTime.UtcNow
                );

                var firstSetOfCatches = new[]
                {
                    MockLiveMatchCatchBuilder.Build(
                        participants[1].Id!,
                        liveMatch.Id,
                        "salmon",
                        2,
        ...
        public void Should_Calculate_LiveMatch_Winner_Correctly(
            LiveMatch liveMatch,
            User expectedWinner
        )
        {
