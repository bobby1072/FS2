...
namespace fsCore.ApiModels
{
    public static class ApiModelExtensions
    {
        ...
        {
            return new GroupCatchComment(input.Id, input.GroupCatchId, input.UserId, input.Comment, input.CreatedAt ?? DateTime.UtcNow);
        }
        ...
        public static async Task<GroupCatch> ToGroupCatchAsync(this SaveCatchFormInput saveCatchFormInput, Guid userId)
        {
